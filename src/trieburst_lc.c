...
static result
search_string_leaf(struct node_leaf *nl, char *word, bool startswith, bool *found) {
    char *in_leaf_suffix;
 ...
 */
static result
getLast(Trie* obj, char *word, struct node_header **nh_out, struct node_header **parent_out) {
...
static bool
trieSearchOption(Trie* obj, char *word, bool startswith) {
   result res;
   struct node_header *nh, *parent_nh;
   struct node_leaf *nl;
   res = getLast(obj, word, &nh, &parent_nh);
...
bool trieSearch(Trie* obj, char * word) {
    return trieSearchOption(obj, word, false);
}

bool trieStartsWith(Trie* obj, char * prefix) {
    return trieSearchOption(obj, prefix, true);
}
